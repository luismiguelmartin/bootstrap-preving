 ...
 */
(function(){"use strict";bootstrap.Util.makeArray(document.querySelectorAll(".tooltip-demo")).forEach(function(t){new bootstrap.Tooltip(t,{selector:'[data-toggle="tooltip"]'})});bootstrap.Util.makeArray(document.querySelectorAll('[data-toggle="popover"]')).forEach(function(t){new bootstrap.Popover(t)});bootstrap.Util.makeArray(document.querySelectorAll(".toast")).forEach(function(t){var e=new bootstrap.Toast(t,{autohide:false});e.show()});bootstrap.Util.makeArray(document.querySelectorAll(".tooltip-test")).forEach(function(t){new bootstrap.Tooltip(t)});bootstrap.Util.makeArray(document.querySelectorAll(".popover-test")).forEach(function(t){new bootstrap.Popover(t)});bootstrap.Util.makeArray(document.querySelectorAll('.bd-example-indeterminate [type="checkbox"]')).forEach(function(t){t.indeterminate=true});bootstrap.Util.makeArray(document.querySelectorAll('.bd-content [href="#"]')).forEach(function(t){t.addEventListener("click",function(t){t.preventDefault()})});var t=document.getElementById("exampleModal");if(t){t.addEventListener("show.bs.modal",function(e){var n=e.relatedTarget;var o=n.getAttribute("data-whatever");var r=t.querySelector(".modal-title");var i=t.querySelector(".modal-body input");r.innerHTML="New message to "+o;i.value=o})}bootstrap.Util.makeArray(document.querySelectorAll(".bd-toggle-animated-progress > .progress-bar-striped")).forEach(function(t){t.addEventListener("click",function(){if(t.classList.contains("progress-bar-animated")){t.classList.remove("progress-bar-animated")}else{t.classList.add("progress-bar-animated")}})});var e='<div class="bd-clipboard"><button type="button" class="btn-clipboard" title="Copiar al portapales">Copiar</button></div>';bootstrap.Util.makeArray(document.querySelectorAll("figure.highlight, div.highlight")).forEach(function(t){t.insertAdjacentHTML("beforebegin",e)});bootstrap.Util.makeArray(document.querySelectorAll(".btn-clipboard")).forEach(function(t){var e=new bootstrap.Tooltip(t);t.addEventListener("mouseleave",function(){e.hide()})});var n=new ClipboardJS(".btn-clipboard",{target:function(t){return t.parentNode.nextElementSibling}});n.on("success",function(t){var e=bootstrap.Tooltip._getInstance(t.trigger);t.trigger.setAttribute("title","¡Copiado!");e._fixTitle();e.show();t.trigger.setAttribute("title","Copiar al portapales");e._fixTitle();t.clearSelection()});n.on("error",function(t){var e=/Mac/i.test(navigator.userAgent)?"⌘":"Ctrl-";var n="Pulsar "+e+"C para copiar";var o=bootstrap.Tooltip._getInstance(t.trigger);t.trigger.setAttribute("title",n);o._fixTitle();o.show();t.trigger.setAttribute("title","Copiar al portapales");o._fixTitle()});anchors.options={icon:"#"};anchors.add(".bd-content > h2, .bd-content > h3, .bd-content > h4, .bd-content > h5");bootstrap.Util.makeArray(document.querySelectorAll(".bd-content > h2, .bd-content > h3, .bd-content > h4, .bd-content > h5")).forEach(function(t){t.innerHTML='<span class="bd-content-title">'+t.innerHTML+"</span>"});bsCustomFileInput.init()})();(function(){"use strict";if(!window.docsearch){return}var t=document.getElementById("search-input");var e=t.getAttribute("data-docs-version");function n(){var t=window.location;var e=t.origin;if(!e){var n=t.port?":"+t.port:"";e=t.protocol+"//"+t.hostname+n}return e}window.docsearch({apiKey:"5990ad008512000bba2cf951ccf0332f",indexName:"bootstrap",inputSelector:"#search-input",algoliaOptions:{facetFilters:["version:"+e]},transformData:function(t){return t.map(function(t){var e=n();var o=/^https?:\/\/getbootstrap\.com/;t.url=e.match(o)?t.url:t.url.replace(o,"");if(t.anchor==="content"){t.url=t.url.replace(/#content$/,"");t.anchor=null}return t})},debug:false})})();